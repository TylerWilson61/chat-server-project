...
'''
We added our own window_login function in the server as well as a get_users function.
We also moved the search function to the state machine to get get our messages 
Encrypted when they are displayed
'''

#TO RUN

#open up the login_window.py ~ run
#
